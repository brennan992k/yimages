...
import 'package:yimages/core/_widgets/alignments.dart';
import 'package:yimages/data/book_data.dart';
import 'package:yimages/presentations/views/editor_page/scrap_popup_editor/animated_menu_panel.dart';
import 'package:yimages/presentations/views/editor_page/scrap_popup_editor/scrap_popup_editor.dart';
...
class _ExamplePopupPanelState extends State<_ExamplePopupPanel> {
          ...
          children: [
            ...
            ..._sortChildrenWithSelectedOnTop([
              ...
              animatedPanel(
                ...
                index: 0,
                openHeight: 100,
                childBuilder: (bool isOpen) =>
                    Content("CONTROL-1", Colors.green, isOpen: isOpen),
              ),
              ...
              animatedPanel(
                ...
                openHeight: 100,
                childBuilder: (bool isOpen) =>
                    Content("CONTROL-2", Colors.red, isOpen: isOpen),
              ),
              ...
              animatedPanel(
                ...
                openHeight: 160,
                childBuilder: (bool isOpen) =>
                    Content("CONTROL-3", Colors.blue, isOpen: isOpen),
              ),
              ...
              animatedPanel(
                ...
                openHeight: 160,
                childBuilder: (bool isOpen) =>
                    Content("CONTROL-4", Colors.orange, isOpen: isOpen),
              ),
            ]),
          ],
        ),
  ...
  List<AnimatedMenuPanel> _sortChildrenWithSelectedOnTop(
      List<AnimatedMenuPanel> list) {
...
class Content extends StatelessWidget {
  const Content(this.lbl, this.color, {Key? key, required this.isOpen})
      : super(key: key);
  final bool isOpen;
  final Color color;
  final String lbl;
    ...
    return AnimatedSwitcher(
      ...
      child: Container(
        ...
        child: Stack(fit: StackFit.expand, children: [
          ...
          if (isOpen)
            Center(child: Text(lbl, style: const TextStyle(fontSize: 32)))
        ]),
      ),
    );
  }
