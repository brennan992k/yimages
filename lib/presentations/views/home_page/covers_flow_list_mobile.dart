...
import 'package:yimages/presentations/views/home_page/book_cover/book_cover.dart';
...
class _CoversFlowListMobileState extends State<CoversFlowListMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    ScrapBookData? nextBook =
        nextPage == _currentPage ? null : widget.books[nextPage];
      ...
      body: ClipRect(
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (_, index) =>
                BookCoverWidget(widget.books[index], largeMode: true),
          ),
