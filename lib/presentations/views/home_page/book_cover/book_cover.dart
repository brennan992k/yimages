...
import 'package:yimages/core/_widgets/animated/animated_scale.dart' as amscale;
import 'package:yimages/core/_widgets/gradient_container.dart';
import 'package:yimages/core/_widgets/rounded_card.dart';
import 'package:yimages/core_packages.dart';
import 'package:yimages/data/book_data.dart';
import 'package:yimages/presentations/views/home_page/book_cover/book_cover_large.dart';
import 'package:yimages/presentations/views/home_page/book_cover/book_cover_small.dart';
                ...
                Align(
                  ...
                  child: AnimatedContainer(
                    ...
                    padding: EdgeInsets.all(
                        widget.largeMode ? Insets.offset : Insets.sm),
                    child: (widget.largeMode)
                        ? LargeBookCover(widget.data)
                        : SmallBookCover(widget.data,
