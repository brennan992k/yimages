...
import 'package:yimages/commands/books/create_folio_command.dart';
...
class HomeNavToggleMenu extends StatelessWidget {
      ...
      builder: (_, constraints) {
        ...
        return Padding(
          padding: EdgeInsets.symmetric(
              horizontal: Insets.offset, vertical: Insets.lg),
          child: Row(
            children: [
              UiText(
                span: TextSpan(
                  ...
                  style: TextStyles.body1.copyWith(
                      height: 1.2,
                      color: showListView ? theme.greyMedium : theme.surface1),
                  children: <TextSpan>[
                    if (name != null)
                      TextSpan(
                          text: " " + name,
  ...
  void _handleAddBookPressed(BuildContext context) =>
      CreateFolioCommand().run();
