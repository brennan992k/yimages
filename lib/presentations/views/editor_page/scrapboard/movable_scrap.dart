...
import 'package:yimages/core/_widgets/listenable_builder.dart';
import 'package:yimages/core/_widgets/sized_and_translated.dart';
import 'package:yimages/core_packages.dart';
import 'package:yimages/presentations/views/editor_page/scrapboard/movable_scrap_selection_box.dart';
            ...
            children: [
              ...
              Transform.rotate(
                ...
                child: MovableScrapSelectionBox(
                  ...
                  onCornerDrag: (value) =>
                      widget.onCornerDragged(widget.data, value),
                  onRotateDrag: (value) =>
...
class _DraggableHitArea extends StatelessWidget {
  const _DraggableHitArea(this.state, {Key? key, required this.child})
      : super(key: key);
