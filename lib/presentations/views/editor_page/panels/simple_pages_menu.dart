...
class SimplePagesMenu extends StatelessWidget {
  const SimplePagesMenu(this.pages, {required this.selectedPageId, Key? key})
      : super(key: key);
  ...
  void _handlePageBtnPressed(BuildContext context, ScrapPageData data) =>
      SetCurrentPageCommand().run(data);
}
...
class _PageBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color bgColor = isSelected
        ? theme.accent1.withOpacity(.1)
        : theme.surface1.withOpacity(.7);
        ...
        child: RoundedBorder(
          ...
          child: ConstrainedBox(
              ...
              child: Container(
                  ...
                  child:
                      Text(title, style: textStyle.copyWith(color: fgColor)))),
        ),
      ),
    );
  }
