...
import 'package:yimages/core/_utils/color_utils.dart';
import 'package:yimages/core/_utils/timed/debouncer.dart';
import 'package:yimages/commands/books/delete_page_command.dart';
...
class _DraggablePageTitleBtnState extends State<DraggablePageTitleBtn> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget bgWidget =
        Container(color: bgColor, width: 250, height: widget.height);
