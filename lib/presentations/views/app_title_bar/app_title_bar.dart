...
import 'package:yimages/core/_utils/native_window_utils/window_utils.dart';
...
import 'package:yimages/presentations/views/app_title_bar/rounded_profile_button.dart';
import 'package:yimages/presentations/views/app_title_bar/touch_mode_toggle_btn.dart';
    ...
    return Stack(children: [
      ...
      Row(
        ...
        children: [
          if (isMac || isMobile) ...[
            if (isMac)
              const HSpace(80), // Reserve some space for the native btns
...
class _TitleText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const IgnorePointer(
      child: Center(
          child: AppLogoText(constraints: BoxConstraints(maxHeight: 16))),
    );
  }
}
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            ...
            Text("Back",
                style: TextStyles.body2.copyWith(color: theme.greyStrong)),
            HSpace.med
          ],
        ),
      ),
