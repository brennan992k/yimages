...
import 'package:yimages/commands/app/save_image_to_disk_command.dart';
import 'package:yimages/commands/books/delete_page_scrap_command.dart';
import 'package:yimages/commands/books/shift_placed_scraps_sort_order_command.dart';
import 'package:yimages/commands/books/update_current_book_cover_photo_command.dart';
...
class _ScrapContextMenuState extends State<ScrapContextMenu>
  ...
  Widget build(BuildContext context) {
    ...
    void _handleForwardPressed() =>
        ShiftPlacedScrapsSortOrderCommand().run(1, widget.scrap);
    void _handleBackPressed() =>
        ShiftPlacedScrapsSortOrderCommand().run(-1, widget.scrap);
    void _handleCoverPhotoPressed() async =>
        UpdateCurrentBookCoverPhotoCommand().run(widget.scrap);
    void _handleSaveImagePressed() async =>
        SaveImageToDiskCommand().run(widget.scrap.data);
    ...
    bool isCoverPhoto =
        widget.scrap.isPhoto && widget.scrap.data == currentCoverPhoto;
      ...
      [
        buttonBuilder(
          ...
          ContextMenuButtonConfig(
            ...
            iconHover:
                const ContextMenuIconHovered(icon: AppIcons.move_forward),
            shortcutLabel: "ctrl + ]",
        ...
        buttonBuilder(
            ...
            ContextMenuButtonConfig("Send backward",
                ...
                iconHover:
                    const ContextMenuIconHovered(icon: AppIcons.send_backward),
          ...
          if (SaveImageToDiskCommand.canUse) ...{
            buttonBuilder(
                ...
                ContextMenuButtonConfig("Save Image As...",
                    ...
                    iconHover:
                        const ContextMenuIconHovered(icon: AppIcons.image),
                    onPressed: () =>
                        handlePressed(context, _handleSaveImagePressed))),
            const ContextDivider(),
          },
          buttonBuilder(
              context,
              ContextMenuButtonConfig("Set as cover photo",
                  ...
                  icon: ContextMenuIcon(
                      icon: AppIcons.star,
                      color: isCoverPhoto ? theme.accent1 : null),
        ...
        buttonBuilder(
            ...
            ContextMenuButtonConfig("Delete",
                ...
                iconHover:
                    const ContextMenuIconHovered(icon: AppIcons.trashcan),
