...
import 'package:yimages/main_app_scaffold.dart';
import 'package:yimages/presentations/routing/app_link.dart';
import 'package:yimages/presentations/views/auth_page/auth_page.dart';
import 'package:yimages/presentations/views/editor_page/editor_page.dart';
import 'package:yimages/presentations/views/home_page/home_page.dart';
import 'package:yimages/presentations/views/splash_page.dart';
...
class AppRouterDelegate extends RouterDelegate<AppLink> with ChangeNotifier {
  ...
  Future<void> setNewRoutePath(AppLink configuration) async {
    ...
    if (configuration.user != null &&
        configuration.user != appModel.currentUserEmail) {
